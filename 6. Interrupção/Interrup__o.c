...
#define  outP   ra0_bit                      //saída de teste oscilando em polling
#define  outT0  ra1_bit                      //saída de teste oscilando com Overflow do Timer0 e interrupção
...
void main()
{
     ...
     TRISa   = 0xFC;                           //RB7, RB6 configurados como saída (0011 1111b)
